...
def sphere_corr(protein_1, protein_2, attribute):
...
def top_sphere_corr(score_matrix, attribute):
...
class topCubeScore:
    ...
    def Main(self):
        score_matrix = sphere_corr(self.protein_1, self.protein_2, self.attribute)
